  ...
  const content = (
    <>
      ...
      <div className="absolute bottom-8 md:bottom-12 left-8 md:left-12 flex flex-col gap-3 md:gap-4 z-20 max-w-[calc(100%-6rem)] md:max-w-[calc(100%-9rem)] pr-4">
        <h3
          className="text-[2.4375rem] md:text-[3.1875rem] lg:text-[3.9375rem] xl:text-[5.4375rem] 2xl:text-[7.4375rem] font-thin text-white uppercase tracking-widest leading-none drop-shadow-lg"
