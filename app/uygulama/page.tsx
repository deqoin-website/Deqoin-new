...
export default function UygulamaPage() {
  ...
  return (
    <main className="site-shell project-detail-shell material-studio-page uygulama-page h-screen w-full overflow-y-auto snap-y snap-proximity scroll-smooth scroll-pt-20" style={{ background: "#0a0a0a" }}>
