...
export default function UploadPage() {
  ...
  const handleUpload = async (event: React.FormEvent) => {
    ...
    try {
      ...
      alert('Upload failed. Check your BLOB_READ_WRITE_TOKEN in .env');
    } finally {
  ...
  return (
    <div style={{ padding: '4rem', background: '#000', minHeight: '100vh', color: '#fff', textAlign: 'center' }}>
      <h1 style={{ marginBottom: '2rem', fontSize: '2rem' }}>Vercel Blob Test Upload</h1>
      ...
      {blob && (
        <div style={{ marginTop: '4rem' }}>
          ...
          <div style={{ position: 'relative', width: '300px', height: '300px', margin: '0 auto' }}>
            <img src={blob.url} alt="Uploaded" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>
