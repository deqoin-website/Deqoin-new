...
export default function OurTeam() {
  ...
  return (
    <main className="site-shell project-detail-shell" style={{ paddingTop: "12rem" }}>
      ...
      <style jsx>{`
        .team-bio-mini { font-size: 0.7rem; color: #fff; opacity: 0.7; line-height: 1.5; margin-top: 0.5rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
        ...
        .team-card-gallery :global(.team-card-copy h3),
        .team-card-gallery :global(.team-card-footer),
        .team-card-gallery :global(.team-card-footer .material-symbols-outlined) { color: #fff; }
