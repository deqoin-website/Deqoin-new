...
const DEFAULT_CARDS = [
  { studioType: 'design', title: 'Design Studio', description: 'Mimari Tasarım', icon: 'PenTool', image: '', order: 0 },
  { studioType: 'material', title: 'Material Studio', description: 'Ürün ve Malzeme', icon: 'Layers', image: '', order: 1 },
  { studioType: 'execution', title: 'Execution Studio', description: 'Uygulama Hizmetleri', icon: 'Hammer', image: '', order: 2 },
];
