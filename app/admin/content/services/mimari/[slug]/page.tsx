              ...
              <div className="grid gap-6 xl:grid-cols-[340px_minmax(0,1fr)]">
                <Card className="border border-[color:var(--line)] bg-[color:var(--surface-muted)] shadow-none">
                  ...
                  <CardContent className="space-y-4">
                    <AdminImageDropzone
                      ...
                      description="Hero görselini sürükleyin veya tıklayıp seçin."
                ...
                <div className="grid gap-4">
                  <div className="grid gap-4 lg:grid-cols-2">
                    ...
                    <SeoMetaCard
                      title="SEO"
                      description="Bu departmanın başlık ve açıklaması arama sonuçlarında burada yönetilir."
                      canonicalHint={`/mimari/${slug}`}
