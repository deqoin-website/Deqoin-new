...
export default function ExecutionEditor() {
  ...
  const [newService, setNewService] = useState({ title: '', sideLabel: '', slug: '', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBg-MKl4zF6vfhExOXkEX-PKVlktOgQYI9EevfKIIYXVJ2wtmRpvybiQLaOtQdeYc_lIPrntEOUrCatq_Efo6fw-z-0-6TilLvAsA4tcYK-QcbjqdetFT2T2EreDjugTzsElsUeoEqEM9i_daWDWBBOJXiZvrjMKWtS2z5I5ZuzOLXWozpZ8MroEnEj5yRtFuaubPctxfeO_ZAZ5E5Tawo9b6yB5w0pmG4_axQCW--XoR8nAAImAE_M5UpM2vFx3tuR2ePYvZ-VmaY' });
  ...
  const addService = async () => {
    ...
    catSection.items.push({
      ...newService,
      image: newService.image || 'https://lh3.googleusercontent.com/aida-public/AB6AXuBg-MKl4zF6vfhExOXkEX-PKVlktOgQYI9EevfKIIYXVJ2wtmRpvybiQLaOtQdeYc_lIPrntEOUrCatq_Efo6fw-z-0-6TilLvAsA4tcYK-QcbjqdetFT2T2EreDjugTzsElsUeoEqEM9i_daWDWBBOJXiZvrjMKWtS2z5I5ZuzOLXWozpZ8MroEnEj5yRtFuaubPctxfeO_ZAZ5E5Tawo9b6yB5w0pmG4_axQCW--XoR8nAAImAE_M5UpM2vFx3tuR2ePYvZ-VmaY'
    });
    
    setContent(newContent);
    setIsAddModalOpen(false);
    setNewService({ title: '', sideLabel: '', slug: '', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBg-MKl4zF6vfhExOXkEX-PKVlktOgQYI9EevfKIIYXVJ2wtmRpvybiQLaOtQdeYc_lIPrntEOUrCatq_Efo6fw-z-0-6TilLvAsA4tcYK-QcbjqdetFT2T2EreDjugTzsElsUeoEqEM9i_daWDWBBOJXiZvrjMKWtS2z5I5ZuzOLXWozpZ8MroEnEj5yRtFuaubPctxfeO_ZAZ5E5Tawo9b6yB5w0pmG4_axQCW--XoR8nAAImAE_M5UpM2vFx3tuR2ePYvZ-VmaY' });
  };

  const removeService = (index: number) => {
    if (!confirm("Bu hizmet birimini silmek istediğinize emin misiniz?")) return;
    const newContent = { ...content };
    const catSection = newContent.sections.find((s: any) => s.id === 'categories');
    ...
    <div className="editor-container">
      <div className="editor-header">
        <div className="header-info">
          <h1>Execution Studio Yönetimi</h1>
          <p>Tüm uygulama birimlerini, inşaat ekiplerini ve ana girişi buradan yönetin.</p>
        </div>
        ...
        <section className="section-card">
          <div className="section-title" style={{ justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <h2>Uygulama Birimleri ve Ekipler</h2>
            </div>
            <button className="add-area-btn" onClick={() => setIsAddModalOpen(true)}>
              <PlusCircle size={18} />
              <span>YENİ BİRİM EKLE</span>
            </button>
          </div>
              ...
              <div key={idx} className="category-item-card">
                ...
                <div className="cat-info">
                  ...
                  <div className="cat-actions">
                    <a href={`/admin/content/services/execution/${item.slug}`} className="detail-edit-link">
        ...
        <div className="modal-overlay">
          <div className="modal-content">
            <div className="modal-header">
              <h3>Yeni Uygulama Birimi Ekle</h3>
